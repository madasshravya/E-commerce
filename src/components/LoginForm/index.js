...
import newLogo from '../../assets/images/loginpagelogo.jpg'
import shoppingfriends from '../../assets/images/shoppingfriends.jpg'
  ...
  render() {
    ...
    return (
      <div className="login-form-container">
        <img className="login-website-logo-mobile-img" src={newLogo} alt="website logo"/>
        <img
          src={shoppingfriends}
          className="login-img"
          alt="website login"
